<?php
/**
 * Settings class for Alex Travel Consultant
 */
...
class AlexSettings {
    ...
    public static function register_settings() {
        ...
        register_setting('alex_consultant_settings', 'alex_openai_api_key');
        ...
        add_settings_field(
            'alex_openai_api_key',
            __('OpenAI API Key', 'alex-travel-consultant'),
            array(__CLASS__, 'password_field_callback'),
            'alex_consultant_settings',
            'alex_basic_settings',
            array('name' => 'alex_openai_api_key', 'value' => get_option('alex_openai_api_key'))
        );
    }
    ...
    public static function password_field_callback($args) {
        ...
        <p class="description"><?php echo esc_html__('Get your API key from https://platform.openai.com/api-keys', 'alex-travel-consultant'); ?></p>
        <?php
    }
}
